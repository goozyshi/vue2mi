  ...
  <div class="cart">
      ...
      <div class="container">
        <div class="cart-box">
          <ul class="cart-item-head">
            <li class="col-1"><span class="checkbox" :class="{'checked':allChecked}" @click="toggleAll"></span></li>
          ...
          <ul class="cart-item-list">
            <li class="cart-item" v-for="(item,index) in list" :key="index">
              ...
              <div class="item-num">
                <div class="num-box">
                  <a href="javascript: void(0);" @click="updateCart(item, '-')">-</a>
    ...
    <no-data v-if="!list.length">
      <template slot="default">
        <buttun v-if="userName" class="btn" @click="$router.push('/index')">去添加</buttun>
      </template>
    </no-data>
...
export default {
  ...
  methods: {
    ...
    updateCart(item, type) {
      let { quantity, productSelected: selected } = item
      if (type == '-') {
        if (quantity == 1) {
