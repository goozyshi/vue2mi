      ...
      <div class="container">
        <div class="order-box">
          <div class="item-address">
            ...
            <div class="addr-list clearfix">
              <div class="addr-info" :class="{'checked':index === checkIndex}" @click="checkIndex=index" v-for="(item,index) in list" :key="index">
                ...
                <div class="action">
                  <a href="javascript: void(0);" class="fl" @click="delAddress(item)">
                    <svg class="icon icon-del">
                      <use xlink:href="#icon-del"></use>
                    </svg>
                  </a>
                  <a href="javascript: void(0);" class="fr" @click="editAddressModal(item)">
          ...
          <div class="btn-group">
            ...
            <a href="javascript: void(0);" class="btn btn-large" @click="orderSubmit">去结算</a>
          </div>
        </div>
      </div>
    </div>
