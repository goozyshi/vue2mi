<template>
  <div class="detail">
    <product-info :title="product.name"></product-info>
    <div class="wrapper">
...
import detail1 from '@/assets/imgs/detail/phone-1.jpg'
import detail2 from '@/assets/imgs/detail/phone-2.jpg'
import detail3 from '@/assets/imgs/detail/phone-3.jpg'
import detail4 from '@/assets/imgs/detail/phone-4.jpg'
...
<style lang="scss">
  ...
  .detail{
    ...
    .price-info{
      ...
      .desc {
        background: url('https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/43e2954feb6d1b108438481f1d5b0bd3.png') no-repeat center;
        height: 189px;
